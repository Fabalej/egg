 ...
 */
package ejercicioe_6;

import ahoracoServicio.AhorcadoServicio;
...
public class EjercicioE_6 {
    ...
    public static void main(String[] args) {
        ...
        AhorcadoServicio na = new AhorcadoServicio();
        Ahorcado nj = new Ahorcado();
        
       na.crearJuego();
       na.longitudPalabra(nj);
       na.buscarLetra(nj, args);
       na.encontradas(nj);
       na.intentos(nj);
