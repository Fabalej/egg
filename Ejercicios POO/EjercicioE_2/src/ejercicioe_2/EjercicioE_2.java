 ...
 */
package ejercicioe_2;

import Puntos.servicios.PuntosServicio;
...
public class EjercicioE_2 {
    ...
    public static void main(String[] args) {
        ...
        PuntosServicio np = new PuntosServicio();
        
        Puntos pn = np.crearPuntos();
        
        System.out.println("La distancia entre los puntos es de " + Math.round(np.calculoDistancia(pn) * 100.0) / 100.0);
