...
public class EjercicioE_3 {
    ...
    public static void main(String[] args) {
        ...
        Raices nr1 = sr.ingresarDatos();
        
        sr.getDiscriminante(nr1);
        
        sr.tieneRaices(sr.getDiscriminante(nr1));
        
        sr.tieneRaiz(sr.getDiscriminante(nr1));
        
        sr.obtenerRaices(nr1, sr.tieneRaices(sr.getDiscriminante(nr1)));
        
        sr.obtenerRaiz(nr1, sr.tieneRaiz(sr.getDiscriminante(nr1)));
        
        sr.calcularRaizces(nr1, sr.tieneRaices(sr.getDiscriminante(nr1)), sr.tieneRaiz(sr.getDiscriminante(nr1)));
